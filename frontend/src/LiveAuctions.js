...
function LiveAuctions() {
  ...
  const fetchLiveAuctions = async () => {
    ...
    try {
      ...
      const response = await axios.get('https://backend-production-e909.up.railway.app/api/liveauctions/filter', {
        params: queryParams,
        headers: headers
      });
  ...
  const fetchFilterCounts = async () => {
    try {
      ...
      const response = await axios.get('https://backend-production-e909.up.railway.app/api/liveauctions/counts', {
        headers: headers
      });
